...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dich_vu_van_hanhs', function (Blueprint $table) {
            ...
            $table->string('loai_dich_vu', 255);
            $table->string('ten_nha_cung_cap', 255)->nullable();
            $table->string('nguoi_lien_he', 255)->nullable();
            $table->string('so_dien_thoai_lien_he', 255)->nullable();
            $table->string('email_lien_he', 255)->nullable();
            $table->string('ma_dat_dich_vu', 255)->nullable();
