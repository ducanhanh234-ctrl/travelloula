...
@section('content')
    <div class="guide-create-page">
        ...
        <form action="{{ route('Admin.huong-dan-viens.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="ho_ten" class="form-control custom-input" value="{{ old('ho_ten') }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control custom-input" value="{{ old('email') }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" name="password" class="form-control custom-input" placeholder="Nhập mật khẩu">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="ngay_sinh" class="form-control custom-input" value="{{ old('ngay_sinh') }}">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="dia_chi" class="form-control custom-input" value="{{ old('dia_chi') }}"
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="so_cccd" class="form-control custom-input" value="{{ old('so_cccd') }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="ngay_cap_cccd" class="form-control custom-input"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="noi_cap_cccd" class="form-control custom-input"
                        value="{{ old('noi_cap_cccd') }}" placeholder="Ví dụ: Cục CSQLHC về TTXH">
                    <div class="text-danger small mt-1">{{ $errors->first('noi_cap_cccd') }}</div>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Ảnh CCCD mặt trước</label>
                    <input type="file" name="anh_cccd_truoc" class="form-control custom-input" accept="image/*">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" name="anh_cccd_sau" class="form-control custom-input" accept="image/*">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="so_nam_kinh_nghiem" class="form-control custom-input"
                        value="{{ old('so_nam_kinh_nghiem', 0) }}" min="0">
                    <div class="text-danger small mt-1">{{ $errors->first('so_nam_kinh_nghiem') }}</div>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Ngôn ngữ thành thạo</label>
                    <input type="text" name="ngon_ngu_thanh_thao" class="form-control custom-input"
                        value="{{ old('ngon_ngu_thanh_thao') }}" placeholder="Ví dụ: Tiếng Anh, Tiếng Trung, Tiếng Hàn">
                ...
                <div class="col-md-6">
                    ...
                    <select name="trang_thai" class="form-select custom-input">
                        ...
                        <option value="san_sang" {{ old('trang_thai') == 'san_sang' ? 'selected' : '' }}>
                            Sẵn sàng
                        </option>
                        <option value="dang_dan_tour" {{ old('trang_thai') == 'dang_dan_tour' ? 'selected' : '' }}>
                            Đang dẫn tour
                        </option>
                        ...
                        <option value="nghi_viec" {{ old('trang_thai') == 'nghi_viec' ? 'selected' : '' }}>
                            Nghỉ việc
                        </option>
                    </select>>
