...
@section('content')
    <div class="guide-form-page">
        ...
        <form action="{{ route('Admin.huong-dan-viens.update', $huongDanVien->id) }}" method="POST"
            enctype="multipart/form-data" class="guide-form-card">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="gioi_tinh" class="form-select custom-input">
                        ...
                        <option value="nam" {{ old('gioi_tinh', $huongDanVien->gioi_tinh) == 'nam' ? 'selected' : '' }}>
                            Nam</option>
                        <option value="nu" {{ old('gioi_tinh', $huongDanVien->gioi_tinh) == 'nu' ? 'selected' : '' }}>
                            Nữ</option>
                        <option value="khac"
                            {{ old('gioi_tinh', $huongDanVien->gioi_tinh) == 'khac' ? 'selected' : '' }}>Khác</option>
                    </select>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="so_cccd" class="form-control custom-input"
                        value="{{ old('so_cccd', $huongDanVien->so_cccd) }}" placeholder="Nhập số CCCD/CMND">
                ...
                <div class="col-md-6">
                    ...
                    @if ($huongDanVien->anh_cccd_truoc)
                        <div class="cccd-preview mt-3">
                            <img src="{{ asset('storage/' . $huongDanVien->anh_cccd_truoc) }}" alt="CCCD mặt trước">
                            <span>Ảnh CCCD mặt trước hiện tại</span>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-md-6">
                    ...
                    @if ($huongDanVien->anh_cccd_sau)
                        <div class="cccd-preview mt-3">
                            <img src="{{ asset('storage/' . $huongDanVien->anh_cccd_sau) }}" alt="CCCD mặt sau">
                            <span>Ảnh CCCD mặt sau hiện tại</span>
                        </div>
                    @endif
                </div>
            </div>
