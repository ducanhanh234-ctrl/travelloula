                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="number"
                               ...
                               class="input-control"
                               value="{{ old('so_tien_da_thanh_toan', 0) }}">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <textarea name="yeu_cau_dac_biet"
                                  class="textarea-control">{{ old('yeu_cau_dac_biet') }}</textarea>
                    </div>

                    <div class="col-md-6 mb-4">
                        <label class="form-label">Ghi chú</label>
                        <textarea name="ghi_chu"
                                  class="textarea-control">{{ old('ghi_chu') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
