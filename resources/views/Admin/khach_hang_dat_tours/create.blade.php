...
@section('content')
    ...
    <div class="customer-create-page">
        <div class="customer-create-wrap">
                        ...
                        <div class="form-grid one-col">
                            <div class="form-group">
                                <label class="form-label">
                                    Chọn đơn đặt tour <span class="required">*</span>
                                </label>
                    ...
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="ho_ten" class="input-control" value="{{ old('ho_ten') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="gioi_tinh" class="input-control">
                                    ...
                                    <option value="nam" @selected(old('gioi_tinh') == 'nam')>
                                        Nam
                                    </option>
                                    <option value="nu" @selected(old('gioi_tinh') == 'nu')>
                                        Nữ
                                    </option>
                                    <option value="khac" @selected(old('gioi_tinh') == 'khac')>
                                        Khác
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="loai_hanh_khach" class="input-control">
                                    <option value="adult" @selected(old('loai_hanh_khach') == 'adult')>
                                        Người lớn
                                    </option>
                                    <option value="child" @selected(old('loai_hanh_khach') == 'child')>
                                        Trẻ em
                                    </option>
                                    <option value="baby" @selected(old('loai_hanh_khach') == 'baby')>
                                        Em bé
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="loai_giay_to" class="input-control"
                                    value="{{ old('loai_giay_to') }}" placeholder="CCCD, CMND, Hộ chiếu...">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="so_giay_to" class="input-control"
                                    value="{{ old('so_giay_to') }}" placeholder="Nhập số giấy tờ">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="so_tien_da_thanh_toan" class="input-control"
                                    value="{{ old('so_tien_da_thanh_toan', 0) }}" placeholder="0">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tong_tien" class="input-control"
                                    value="{{ old('tong_tien', 0) }}" placeholder="0">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="so_phong" class="input-control"
                                    value="{{ old('so_phong') }}" placeholder="Nhập số phòng">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="loai_phong" class="input-control">
                                    ...
                                    <option value="phong_don" @selected(old('loai_phong') == 'phong_don')>
                                        Phòng đơn
                                    </option>

                                    <option value="phong_doi" @selected(old('loai_phong') == 'phong_doi')>
                                        Phòng đôi
                                    </option>

                                    <option value="phong_twin" @selected(old('loai_phong') == 'phong_twin')>
                                        Phòng twin
                                    </option>

                                    <option value="phong_ba" @selected(old('loai_phong') == 'phong_ba')>
                                        Phòng ba
                                    </option>

                                    <option value="phong_gia_dinh" @selected(old('loai_phong') == 'phong_gia_dinh')>
                                        Phòng gia đình
                                    </option>

                                    <option value="phong_deluxe" @selected(old('loai_phong') == 'phong_deluxe')>
                                        Phòng Deluxe
                                    </option>

                                    <option value="phong_suite" @selected(old('loai_phong') == 'phong_suite')>
                                        Phòng Suite
                                    </option>

                                    <option value="phong_vip" @selected(old('loai_phong') == 'phong_vip')>
                                        Phòng VIP
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="form-card-body">
                        <div class="form-grid two-cols">
                            <div class="form-group">
                                ...
                                <textarea name="yeu_cau_dac_biet" class="textarea-control" placeholder="Nhập yêu cầu đặc biệt nếu có">{{ old('yeu_cau_dac_biet') }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="ghi_chu" class="textarea-control" placeholder="Nhập ghi chú">{{ old('ghi_chu') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
