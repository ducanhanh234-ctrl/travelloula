    ...
    <form method="GET" action="{{ route('Admin.phuong-tiens.index') }}" class="filter-card">
        <div class="filter-grid">
            <div>
                ...
                <input type="text" name="keyword" value="{{ request('keyword') }}" class="form-control-custom" placeholder="Biển số, hãng xe, tài xế hoặc số điện thoại">
            </div>
        ...
        <table class="vehicle-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('Admin.phuong-tiens.show', $phuongTien->id) }}" class="action-link view">👁</a>

                            <a href="{{ route('Admin.phuong-tiens.edit', $phuongTien->id) }}" class="action-link edit">✏️</a>

                            <form action="{{ route('Admin.phuong-tiens.destroy', $phuongTien->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa xe này?')">
                                @csrf
                                @method('DELETE')
