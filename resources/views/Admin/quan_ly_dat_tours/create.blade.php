            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="tour_id" id="tour_id" required>
                        ...
                        <option value="{{ $tour->id }}" data-adult="{{ $tour->gia_nguoi_lon }}" data-child="{{ $tour->gia_tre_em }}" data-baby="{{ $tour->gia_em_be }}" data-duration="{{ $tour->lichTrinh->count() ?: 1 }}">
                            {{ $tour->ten_tour }}
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lich_khoi_hanh" name="lich_khoi_hanh" placeholder="dd/mm/yyyy" required>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="so_nguoi_lon" id="adult_count" class="form-control" value="1" min="0">
                    </div>
                    <div class="col-md-4">
                        <label>
                            Số trẻ em
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" id="tong_tien" name="tong_tien" class="form-control" value="0" readonly>
