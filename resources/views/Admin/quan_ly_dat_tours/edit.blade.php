            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select name="tour_id" class="form-select">
                        ...
                        <option value="{{ $tour->id }}" data-duration="{{ $tour->lichTrinh->count() ?: 1 }}" data-adult-price="{{ $tour->gia_nguoi_lon }}" data-child-price="{{ $tour->gia_tre_em }}" data-baby-price="{{ $tour->gia_em_be }}" {{ $booking->tour_id == $tour->id ? 'selected' : '' }}>
                            {{ $tour->ten_tour }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="date" id="ngay_khoi_hanh" name="ngay_khoi_hanh" class="form-control" value="{{ optional($booking->lichKhoiHanh?->ngay_khoi_hanh)->format('Y-m-d') }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" readonly id="ngay_ket_thuc" name="ngay_ket_thuc" class="form-control" value="{{ optional($booking->lichKhoiHanh)->ngay_ket_thuc }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input id="adult_count" name="so_nguoi_lon" type="number" min="0" class="form-control" value="{{ $booking->so_nguoi_lon }}">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="child_count" name="so_tre_em" type="number" min="0" class="form-control" value="{{ $booking->so_tre_em }}">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="baby_count" name="so_em_be" type="number" min="0" class="form-control" value="{{ $booking->so_em_be }}">
                    </div>
                </div>
                ...
                <div id="passenger-container">
                    ...
                    <div class="card mb-3 passenger-card" data-type="{{ $hk->loai_hanh_khach }}">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" onclick="removeOldPassenger(this,{{ $hk->id }})">
                                Xóa
                            </button>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="hanh_khach[{{ $index }}][ho_ten]" value="{{ $hk->ho_ten }}">
                                </div>
                                <div class="col-md-4">
                                    <label>
                                        Giới tính
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="hanh_khach[{{ $index }}][nam_sinh]" value="{{ $hk->nam_sinh }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="tong_tien" readonly class="form-control" value="{{ number_format($booking->tong_tien, 0, ',', '.') }} VNĐ">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="so_tien_da_thanh_toan" class="form-control" value="{{ $booking->so_tien_da_thanh_toan }}">
                </div>
