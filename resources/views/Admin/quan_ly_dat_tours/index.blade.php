                        ...
                        <div class="booking-filter-field">
                            ...
                            <div class="booking-filter-control">
                                ...
                                <input type="text" name="keyword" id="keyword" class="form-control"
                                    placeholder="Tên Tour, mã booking hoặc khách hàng..."
                                    value="{{ $filters['keyword'] ?? '' }}" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <tbody>
                            @forelse ($bookings ?? [] as $booking)
                                <tr>
                                        ...
                                        @if ($booking->lichKhoiHanh?->huongDanVien)
                                            <div class="booking-guide">
                                                ...
                                                <span class="guide-name"
                                                    title="{{ $booking->lichKhoiHanh->huongDanVien->ho_ten }}">
                                    ...
                                    <td>
                                        <span class="booking-status badge-{{ $booking->trang_thai_badge }}">
                                    ...
                                    <td>
                                        <div class="booking-actions">
                                            ...
                                            <form action="{{ route('Admin.dat_tours.destroy', $booking->id) }}"
                                                method="POST"
                                                onsubmit="return confirm('Chuyển booking này vào thùng rác?');">
                                                @csrf
                                                @method('DELETE')

                                                <button type="submit" class="btn-table-action btn-soft-delete"
