        ...
        <form action="{{ route('Admin.quan_ly_dat_tour.index') }}" method="GET">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="keyword" class="form-control" placeholder="Tên tour, mã booking..." value="{{ $filters['keyword'] ?? '' }}">
                </div>
                <div class="col-md-4">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            {{-- Xem chi tiết --}}
                            <a href="{{ route('Admin.dat_tours.show', $booking->id) }}" class="btn btn-sm btn-outline-info" title="Xem chi tiết">
                                <i class="fas fa-eye"></i>
                            </a>

                            {{-- Xóa mềm --}}
                            <form action="{{ route('Admin.dat_tours.destroy', $booking->id) }}" method="POST" onsubmit="return confirm('Chuyển booking vào thùng rác?')">
