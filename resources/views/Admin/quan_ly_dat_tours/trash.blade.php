...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('Admin.quan_ly_dat_tour.index') }}" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            {{-- Khôi phục --}}
                            <form action="{{ route('Admin.dat_tours.restore',$booking->id) }}" method="POST">
                                @csrf
                            ...
                            {{-- Xóa vĩnh viễn --}}
                            <form action="{{ route('Admin.dat_tours.forceDelete',$booking->id) }}" method="POST" onsubmit="return confirm('Xóa vĩnh viễn booking này?')">
                                @csrf
                                @method('DELETE')
