...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <h4 class="mb-1">Thêm Tour</h4>
        <p class="text-muted mb-0">
            Tạo mới tour du lịch trong hệ thống
        </p>
    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ten_tour" class="form-control" value="{{ old('ten_tour') }}">
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="tong_quan_lich_trinh" rows="5" class="form-control"></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="dich_vu_bao_gom" rows="5" class="form-control"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="dich_vu_khong_bao_gom" rows="5" class="form-control"></textarea>
                    </div>
