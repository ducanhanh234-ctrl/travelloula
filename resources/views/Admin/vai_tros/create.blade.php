    ...
    <div class="container-fluid role-form-page">
        <div class="form-page-top">
            <div class="page-heading">
                ...
                <p>
                    Tạo vai trò và lựa chọn các quyền hạn phù hợp.
                </p>
            </div>
        ...
        <div class="card role-form-card">
            <div class="form-header">
                <div class="form-header-content">
                    ...
                    <div>
                        ...
                        <p>
                            Khai báo thông tin và thiết lập quyền truy cập cho
            ...
            <div class="form-body">
                <form
                    action="{{ route('Admin.vai-tros.store') }}"
                    method="POST"
                >
                    @csrf
                        ...
                        <div class="form-row-custom">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-hint">
                                    ...
                                    <span>
                                        Mô tả ngắn gọn trách nhiệm của vai trò
                                        trong hệ thống.
                                    </span>
                                </div>
