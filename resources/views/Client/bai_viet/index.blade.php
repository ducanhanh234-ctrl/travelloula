        ...
        <div class="col-lg-3">
            ...
            <div class="card newsletter-card text-white border-0 p-4 mb-4 shadow-sm">
                ...
                <div class="input-group">
                    <input type="email" class="form-control border-0 rounded-start-pill ps-3" placeholder="Email của bạn...">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card border-0 shadow-sm h-100 post-card">
                        <div class="overflow-hidden">
                            <img src="https://picsum.photos/500/300?random={{$i}}" class="card-img-top card-img-hover" alt="Travel Image">
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            <div>
                                ...
                                <p class="text-muted small mb-4 line-clamp-3">
                                    Khám phá những địa điểm tuyệt đẹp, những trải nghiệm văn hóa độc đáo đang chờ đón bước chân bạn trong năm nay...
                                </p>
                            </div>

                            <a href="{{route('bai_viet.detail',1)}}" class="btn btn-outline-primary rounded-pill fw-semibold w-100 py-2">
                                Xem chi tiết
                            </a>
                        </div>
                    </div>
...
.post-card:hover .card-img-hover {
    transform: scale(1.05); /* Hiệu ứng zoom nhẹ ảnh khi di chuột vào card */
}
