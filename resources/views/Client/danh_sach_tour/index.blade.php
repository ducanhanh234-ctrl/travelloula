    ...
    <div class="tour-container">
        ...
        <div class="tour-hero-clean">
            ...
            <div class="tour-hero-photo">
                <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1800&q=80" alt="Du lịch Travelloula">
        ...
        <div class="category-section">
            ...
            <div class="category-scroll">
                <a href="{{ route('Client.danh_sach_tour.index') }}" class="category-pill {{ request('danh_muc_id') ? '' : 'active' }}">
                ...
                <a href="{{ route('Client.danh_sach_tour.index', array_merge(request()->except('page'), ['danh_muc_id' => $dm->id])) }}" class="category-pill {{ request('danh_muc_id') == $dm->id ? 'active' : '' }}">
        ...
        <form action="{{ route('Client.danh_sach_tour.index') }}" method="GET" class="tour-filter">
            <input type="text" name="keyword" value="{{ request('keyword') }}" placeholder="Tìm tour, điểm đến, nơi khởi hành...">
            ...
            <input type="number" name="gia_min" value="{{ request('gia_min') }}" placeholder="Giá từ">

            <input type="number" name="gia_max" value="{{ request('gia_max') }}" placeholder="Giá đến">

            <input type="text" name="phuong_tien" value="{{ request('phuong_tien') }}" placeholder="Phương tiện">

            <input type="date" name="ngay_khoi_hanh" value="{{ request('ngay_khoi_hanh') }}">
        ...
        <div class="tour-grid">
            ...
            <article class="tour-card">
                <div class="tour-img">
                    <img src="{{ $srcAnh }}" alt="{{ $tour->ten_tour }}" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=80';">
                    ...
                    @auth
                    @if($isFavorite)
                    <form action="{{ route('Client.tour_yeu_thich.destroy', $tour->id) }}" method="POST" class="favorite-form">
                        @csrf
                        @method('DELETE')
                    ...
                    @else
                    <form action="{{ route('Client.tour_yeu_thich.store', $tour->id) }}" method="POST" class="favorite-form">
                        @csrf
                ...
                <div class="tour-body">
                    ...
                    <div class="tour-bottom">
                        ...
                        <div class="tour-actions">
                            ...
                            <a href="{{ route('create_dat_tour', $tour->id) }}#dat-tour" class="booking-btn">
                                Đặt tour
                            </a>
                        </div>
                    </div>
    ...
    * {
    ...
    .tour-filter {
        ...
        grid-template-columns:
            minmax(270px, 2.2fr) minmax(160px, 1.15fr) minmax(120px, .85fr) minmax(120px, .85fr) minmax(135px, .95fr) minmax(155px, 1fr) minmax(190px, 1.15fr) minmax(145px, .9fr) minmax(120px, .75fr);
        gap: 12px;
    }
