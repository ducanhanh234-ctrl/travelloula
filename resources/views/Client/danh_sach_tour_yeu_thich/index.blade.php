        ...
        <div class="wishlist-grid">
            ...
            <article class="wishlist-card">
                <div class="tour-image-box">
                    <img src="{{ $tourImage }}" alt="{{ $tour->ten_tour }}" onerror="this.onerror=null;this.src='{{ $fallbackImage }}';">
                    ...
                    <form action="{{ route('Client.tour_yeu_thich.destroy', $tour->id) }}" method="POST" onsubmit="return confirm('Bạn muốn xóa tour này khỏi danh sách yêu thích?')">
                        @csrf
                        @method('DELETE')
                ...
                <div class="tour-content">
                    ...
                    <div class="tour-bottom">
                        ...
                        <div class="tour-actions">
                            ...
                            <a href="{{ route('create_dat_tour', $tour->id) }}#dat-tour" class="book-btn">
                                Đặt tour
                            </a>
                        </div>
                    </div>
