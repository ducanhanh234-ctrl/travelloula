    ...
    <div class="wishlist-container">
        ...
        <div class="wishlist-hero">
            <div>
                ...
                <p>
                    Lưu lại những hành trình bạn quan tâm để dễ dàng xem lại,
                    so sánh giá và đặt tour khi sẵn sàng.
                </p>
            </div>
                            ...
                            <div class="tour-content">
                                ...
                                <div class="tour-bottom">
                                    ...
                                    <div class="tour-actions">
                                        ...
                                        <a href="{{ route('Client.danh_sach_tour.show', $tour->id) }}#dat-tour" class="book-btn">
                                            Đặt tour
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="saved-date">
                                    <i class="fa-regular fa-clock"></i>
                                    Đã lưu ngày {{ $favorite->created_at ? $favorite->created_at->format('d/m/Y') : 'đang cập nhật' }}
                                </div>
                            </div>
                        </article>
                    @endif
