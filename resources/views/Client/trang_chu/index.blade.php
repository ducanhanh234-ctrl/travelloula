            ...
            <div class="tour-grid">
                ...
                <article class="tour-card">
                    <div class="tour-img">
                        ...
                        @auth
                        @if($isFavorite)
                        <form action="{{ route('Client.tour_yeu_thich.destroy', $tour->id) }}" method="POST" class="home-favorite-form">
                            @csrf
                            @method('DELETE')
                        ...
                        @else
                        <form action="{{ route('Client.tour_yeu_thich.store', $tour->id) }}" method="POST" class="home-favorite-form">
                            @csrf
                    ...
                    <div class="tour-body">
                        ...
                        <div class="tour-bottom">
                            ...
                            <div class="tour-actions">
                                ...
                                <a href="{{ route('create_dat_tour', $tour->id) }}#dat-tour" class="book-now-btn">
                                    Đặt tour
                                </a>
                            </div>
                        </div>
