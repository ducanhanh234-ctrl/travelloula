   ...
   ========================================================= */
    ...
    .search-box {
        ...
        grid-template-columns:
            minmax(220px, 1.25fr) minmax(170px, 1fr) minmax(180px, 1fr) minmax(140px, .8fr) minmax(180px, .9fr);
    }

    .search-item {
        min-width: 0;
        padding:
            clamp(17px, 1.6vw, 25px) clamp(18px, 1.7vw, 30px);
    }
    ...
    .stats-box {
        grid-template-columns: repeat(4, minmax(0, 1fr));
        padding:
            clamp(22px, 2vw, 34px) clamp(18px, 2.4vw, 42px);
    }
...
<main>
    ...
    <section class="home-hero home-hero-static">
        <div class="hero-static-image">
            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1920&q=88" alt="Du lịch biển cùng Travelloula">
        </div>
    ...
    <section class="home-section">
        <div class="home-container">
            ...
            <div class="tour-grid">
                ...
                <article class="tour-card tour-card-clickable" role="link" tabindex="0" data-detail-url="{{ route('Client.danh_sach_tour.show', $tour->id) }}" aria-label="Xem chi tiết tour {{ $tour->ten_tour }}">
                    <div class="tour-img">
                        <img src="{{ $tourImage }}" alt="{{ $tour->ten_tour }}" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80';">
                        ...
                        @auth
                        <form action="{{ $isFavorite
                                    ? route('Client.tour_yeu_thich.destroy', $tour->id)
                                    : route('Client.tour_yeu_thich.store', $tour->id) }}" method="POST" class="home-favorite-form js-home-favorite-form" data-store-url="{{ route('Client.tour_yeu_thich.store', $tour->id) }}" data-destroy-url="{{ route('Client.tour_yeu_thich.destroy', $tour->id) }}" data-favorite="{{ $isFavorite ? '1' : '0' }}">
                            @csrf
                            ...
                            <button class="heart {{ $isFavorite ? 'active' : '' }}" type="submit" title="{{ $isFavorite ? 'Bỏ yêu thích' : 'Thêm vào yêu thích' }}" aria-label="{{ $isFavorite ? 'Bỏ yêu thích' : 'Thêm vào yêu thích' }}" aria-pressed="{{ $isFavorite ? 'true' : 'false' }}">
                                <i class="{{ $isFavorite ? 'fa-solid' : 'fa-regular' }} fa-heart"></i>
                            </button>
                        </form>
                        @else
                        <a href="{{ route('login') }}" class="heart" title="Đăng nhập để thêm yêu thích" aria-label="Đăng nhập để thêm yêu thích">
                        ...
                        */
                        ...
                        <div class="tour-bottom">
                            ...
                            <div class="tour-actions">
                                ...
                                <a href="{{ route('Client.danh_sach_tour.show', $tour->id) }}#dat-tour" class="book-now-btn{{ $coLichMoBan ? '' : ' js-tour-message' }}" @unless($coLichMoBan) data-message="{{ $lyDoKhongDat }}" data-block-booking="1" @endunless>
                                    Đặt tour
                                </a>
                            </div>
                        </div>
        ...
        <div class="home-container">
            ...
            <div class="destination-grid">
                ...
                <a href="{{ route('Client.danh_sach_tour.index', ['keyword' => $item->diem_den]) }}" class="destination-card">
                    <img src="{{ $destinationImage }}" alt="{{ $item->diem_den }}" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80';">
        ...
        <div class="home-container">
                ...
                <div class="review-summary">
                    ...
                    <div>
                        <div class="review-summary-stars">
                            @for($star = 1; $star <= 5; $star++) <i class="fa-solid fa-star {{ $star <= round($avgRating) ? 'active' : '' }}"></i>
                                @endfor
                        </div>
            ...
            <div class="review-grid">
                ...
                <article class="review-card">
                    <div class="review-card-top">
                        ...
                        <div class="review-person">
                            ...
                            <div class="review-stars">
                                @for($star = 1; $star <= 5; $star++) <i class="fa-solid fa-star {{ $star <= (int) $review->so_sao ? 'active' : '' }}"></i>
                                    @endfor
                            </div>
                        </div>
                    ...
                    <a href="{{ route('Client.danh_sach_tour.show', $review->tour_id) }}#danh-gia" class="review-tour-link">
                        <i class="fa-solid fa-location-dot"></i>
                        {{ $review->ten_tour }}
                    </a>
                    @endif
