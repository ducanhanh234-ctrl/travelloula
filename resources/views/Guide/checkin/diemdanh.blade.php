                            ...
                            @foreach ($ngay->chiTiets as $chiTiet)
                                ...
                                <div class="location-place-card {{ $previewCancelled ? 'location-place-card-disabled' : '' }}">
                                    ...
                                    <div class="location-place-action">
                                        ...
                                        @if (!$hasCheckedIn && !$completed && $activityStatus !== 'completed')
                                            <button type="button"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="schedule-fields-{{ $chiTiet->id }}">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                name="tieu_de_moi"
                                                                class="form-control"
                                                                value="{{ $scheduleChange?->tieu_de_moi ?? $chiTiet->tieu_de }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="time"
                                                                    ...
                                                                    class="form-control"
                                                                    value="{{ $scheduleChange?->gio_bat_dau_moi ?? $chiTiet->gio_bat_dau }}">
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="time"
                                                                    ...
                                                                    class="form-control"
                                                                    value="{{ $scheduleChange?->gio_ket_thuc_moi ?? $chiTiet->gio_ket_thuc }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="ly_do"
                                                            ...
                                                            maxlength="1000"
                                                            required
                                                            placeholder="Ví dụ: Cả đoàn quá mệt và thống nhất nghỉ ngơi...">{{ $scheduleChange?->ly_do ?? '' }}</textarea>
                                                    </div>
                                                </div>
