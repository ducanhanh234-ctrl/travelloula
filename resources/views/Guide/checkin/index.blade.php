                    ...
                    <tr>
                        <td>
                            <span class="checkin-stt">
                                {{ $loop->iteration + ($lichKhoiHanhs->currentPage() - 1) * $lichKhoiHanhs->perPage() }}
                            </span>
                        </td>
                        ...
                        <td>
                            <span class="badge-status status-paid">
                                {{ $lich->trang_thai == 'running' ? 'Đang diễn ra' : ($lich->trang_thai == 'completed' ? 'Đã kết thúc' : 'Chưa diễn ra') }}
                            </span>
                        </td>
                        <td>
                            <a href="{{ route(
