...
<div class="checkin-page fade-in">
    ...
    <div class="checkin-stats-grid">
        <div class="checkin-stat-card">
            ...
            <div class="checkin-stat-content">
                <div class="checkin-stat-value">{{ $tongKhach }}</div>
    ...
    <div class="checkin-progress-card">
        ...
        <div class="checkin-progress-track">
            <div class="checkin-progress-bar" role="progressbar" style="width: {{ $phanTramCheckIn }}%;" aria-valuenow="{{ $phanTramCheckIn }}" aria-valuemin="0" aria-valuemax="100">
    ...
    <div class="checkin-main-actions">
        <form action="{{ route('Guide.checkin.checkinTatCa') }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn Check-in tất cả hành khách?');">
            ...
            <input type="hidden" name="chi_tiet_lich_trinh_id" value="{{ $chiTiet->id }}">
                                            <input type="hidden" name="checkin_context" value="finish">
    ...
    <div class="checkin-main-actions">
        ...
        @else
            <form action="{{ route('Guide.checkin.finishTour', $lichKhoiHanhId) }}" method="POST"
                  onsubmit="return confirm('Xác nhận kết thúc tour?');">
                @csrf
...
<div class="modal fade checkin-modal" id="ghiChuModal{{ $khach->id }}" tabindex="-1" aria-labelledby="ghiChuModalLabel{{ $khach->id }}" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('Guide.checkin.note') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="checkin-modal-customer"><i class="fas fa-user"></i>
                        {{ $khach->ho_ten }}
                    </div>
