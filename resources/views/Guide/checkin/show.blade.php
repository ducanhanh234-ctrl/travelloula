...
@section('content')
    ...
    <div class="checkin-stats-grid">
        ...
        <div class="checkin-stat-content">
            <div class="checkin-stat-value">{{ $chuaCheck }}</div>
    ...
    <div class="checkin-progress-card">
        <div class="checkin-progress-header">
            <div class="checkin-progress-title">
                <i class="fas fa-chart-line"></i>Tiến độ Check-in</div>
        ...
        <div class="checkin-progress-track">
            <div class="checkin-progress-bar" role="progressbar"
    ...
    <div class="checkin-main-actions">
        <form action="{{ route('Guide.checkin.checkinTatCa') }}" method="POST"
           ...
           <button type="submit" class="btn-checkin btn-checkin-all"
        ...
        <table class="table checkin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="checkin-phone"><i class="fas fa-phone-alt"></i>
                        {{$khach->so_dien_thoai ?: 'Chưa cập nhật'}}</span></td>
                    ...
                    <td>
                        ...
                        @else
                            <span class="checkin-note-empty">Chưa có ghi chú</span>
                            ...
                            <div class="checkin-row-actions">
                                <form action="{{ route('Guide.checkin.store') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn-checkin-row btn-row-checkin"
                                        {{ !$daChot ? 'disabled' : '' }}
                                            title="{{ !$daChot ? 'Bạn phải chốt điểm danh trước' : '' }}"></button>
        ...
        @endphp
            ...
            <div class="modal-body">
                ...
                <label for="ghi_chu_{{ $khach->id }}" class="form-label fw-semibold">
                    Nội dung ghi chú</label>

                <textarea name="ghi_chu" id="ghi_chu_{{ $khach->id }}" class="form-control" rows="4" placeholder="Ví dụ: Khách đến muộn, cần hỗ trợ đặc biệt..." required>
