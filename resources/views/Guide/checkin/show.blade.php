...
{{-- Header --}}
    ...
    <div class="mt-4 d-flex justify-content-end">
        {{ $chiTiet->lichTrinh->ngay_thu }}
        <form id="confirmCheckinForm" action="{{ route('Guide.checkin.saveLock', $lichKhoiHanhId) }}" method="POST">
         @csrf
                            ...
                            <form action="{{ route('Guide.checkin.note') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <textarea name="ghi_chu" id="ghi_chu_{{ $khach->id }}" class="form-control" rows="4"
                                        placeholder="Ví dụ: Khách đến muộn, cần hỗ trợ đặc biệt..."required>{{ $checkIn->ghi_chu ?? '' }}</textarea>
                                </div>
