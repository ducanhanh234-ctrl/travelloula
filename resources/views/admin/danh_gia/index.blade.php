        ...
        <div class="review-card-body">
            <form method="GET" class="review-filter-form">
                <div class="review-filter-group">
                    <label for="search" class="review-filter-label">
                        Tìm kiếm đánh giá
                    </label>
                    ...
                    <div class="review-input-wrapper">
                        ...
                        <input type="text" name="search" id="search" class="form-control" value="{{ request('search') }}" placeholder="Tìm theo khách hàng, Tour hoặc nội dung..." autocomplete="off">
                    </div>
                </div>

                <div class="review-filter-group">
                    <label for="so_sao" class="review-filter-label">
                        Số sao
                    </label>
                    ...
                    <select name="so_sao" id="so_sao" class="form-select">
                        ...
                        <option value="{{ $star }}" @selected((string) request('so_sao')===(string) $star)>
                            {{ $star }} sao
                        </option>
                        @endfor
                    </select>
                ...
                <button type="submit" class="btn-review-filter btn-review-search">
                    <i class="fas fa-search"></i>
                    Tìm kiếm
                </button>

                <a href="{{ url()->current() }}" class="btn-review-filter btn-review-reset">
        ...
        <div class="review-table-wrapper">
            <table class="table review-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="review-customer">
                                ...
                                <div>
                                    <div class="review-customer-name" title="{{ $reviewerName }}">
                                        {{ $reviewerName }}
                                    </div>
                        ...
                        <td>
                            <div class="review-stars">
                                @for ($i = 1; $i <= 5; $i++) <i class="fas fa-star {{ $i <= $danh_gia->so_sao ? 'review-star-active' : '' }}"></i>
                                    @endfor
                        ...
                        <td>
                            <div class="review-actions">
                                <a href="{{ route('Admin.danh_gias.show', $danh_gia->id) }}" class="btn-review-action btn-review-view" title="Xem chi tiết">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <form action="{{ route('Admin.danh_gias.destroy', $danh_gia->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa đánh giá này?');">
                                    @csrf
                                    @method('DELETE')

                                    <button type="submit" class="btn-review-action btn-review-delete" title="Xóa đánh giá">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="review-empty-row">
