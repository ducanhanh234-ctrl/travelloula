...
@section('content')
    <style>
        ...
        .category-form-section .file-control {
            padding: 8px 11px;
        }
        ...
        .category-form-section .form-control:hover,
        .category-form-section .form-select:hover {
            border-color: #b6c9e8;
        }
    ...
    @php
        $categoryStatus = old('trang_thai', 'active');
    @endphp
        ...
        <div class="category-page-header">
            <div class="category-page-heading">
                ...
                <div>
                    ...
                    <p>
                        Tạo danh mục mới để phân loại các Tour trong hệ thống.
                    </p>
                </div>
            </div>
            ...
            <div class="category-card-header">
                <div class="category-card-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Nhập thông tin, chọn ảnh và trạng thái danh mục.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="category-card-body">
                ...
                >
                    ...
                    <div class="category-form-section">
                        <div class="category-form-header">
                            ...
                            <div>
                                ...
                                <p>
                                    Nhập tên, mô tả, hình ảnh và trạng thái.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="category-form-grid">
                                ...
                                <div class="category-form-group">
                                    ...
                                    <input
                                        ...
                                        name="hinh_anh"
                                        id="hinh_anh"
                                        class="form-control file-control @error('hinh_anh') is-invalid @enderror"
                                    ...
                                    <div class="category-form-hint">
                                        ...
                                        <span>
                                            Chọn ảnh JPG, JPEG, PNG hoặc WEBP
                                            từ máy tính.
                                        </span>
                                    </div>
                                    ...
                                    <div
                                        id="category_image_preview_wrapper"
                                        class="category-image-preview-wrapper"
                                    >
                                        <div class="category-image-preview-title">
                                            Ảnh xem trước
                                        </div>

                                        <div class="category-image-preview-box">
                                            <img
                                                src=""
                                ...
                                <div class="category-form-group">
                                    ...
                                    <div class="category-input-wrapper">
                                        ...
                                        >
                                            <option
                                                value="active"
                                                @selected($categoryStatus === 'active')
                                            >
                                                Hoạt động
                                            </option>
                                            ...
                                            <option
                                                value="inactive"
                                                @selected($categoryStatus === 'inactive')
                                            >
                                                Không hoạt động
                                            </option>
                                        </select>
                                    ...
                                    <div class="category-status-preview">
                                        ...
                                        <span
                                            id="category_status_preview"
                                            class="category-status-badge"
                                        >
                    ...
                    <div class="category-form-actions">
                        <a
                            href="{{ route('Admin.danh_mucs.index') }}"
                            class="btn-category-action btn-category-cancel"
                        >
                            <i class="fas fa-times"></i>
                            Hủy
                        </a>
                        ...
                        <button
                            type="submit"
                            class="btn-category-action btn-category-save"
                        >
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const imageInput =
                document.getElementById('hinh_anh');

            const imagePreview =
                document.getElementById('category_image_preview');

            const imagePreviewWrapper =
                document.getElementById(
                    'category_image_preview_wrapper'
                );

            const imageRemoveButton =
                document.getElementById('category_image_remove');
