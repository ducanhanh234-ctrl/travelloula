...
<div class="container-fluid payment-page">
    ...
    <div class="payment-card payment-filter-card">
        ...
        <div class="payment-card-body">
            <form method="GET" action="{{ route('Admin.thanh_toans.index') }}" class="payment-filter-form">
                <div class="payment-filter-group">
                    <label for="search" class="payment-filter-label">
                        Mã giao dịch
                    </label>
                    ...
                    <div class="payment-input-wrapper">
                        ...
                        <input type="text" name="search" id="search" class="form-control" value="{{ request('search') }}" placeholder="Nhập mã giao dịch..." autocomplete="off">
                    </div>
                </div>

                <div class="payment-filter-group">
                    <label for="status" class="payment-filter-label">
                        Trạng thái
                    </label>
                    ...
                    <select class="form-select" name="status" id="status">
                        ...
                        <option value="da_thanh_toan" @selected(request('status')==='da_thanh_toan' )>
                            Đã thanh toán
                        </option>

                        <option value="cho_thanh_toan" @selected(request('status')==='chua_thanh_toan' )>
                            Chưa thanh toán
                        </option>

                        <option value="that_bai" @selected(request('status')==='thanh_toan_that_bai' )>
                            Thất bại
                        </option>

                        <option value="hoan_tien" @selected(request('status')==='hoan_tien' )>
                            Hoàn tiền
                        </option>
                        <option value="cho_xu_ly" @selected(request('status')==='cho_xu_ly' )>
                            Chờ xử lý
                        </option>
                    </select>
                </div>

                <button type="submit" class="btn-payment-filter btn-payment-search">
                    <i class="fas fa-search"></i>
                    Tìm kiếm
                </button>

                <a href="{{ route('Admin.thanh_toans.index') }}" class="btn-payment-filter btn-payment-reset">
        ...
        <div class="payment-table-wrapper">
            <table class="table payment-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="payment-customer">
                                ...
                                <div>
                                    <div class="payment-customer-name" title="{{ $tenKhachHang }}">
                                        {{ $tenKhachHang }}
                                    </div>
                        ...
                        <td>
                            <span class="payment-method {{ $paymentMethodClass }}">
                        ...
                        <td>
                            <div class="payment-actions">
                                <a href="{{ route(
                                                ...
                                                $thanh_toan->id
                                            ) }}" class="btn-payment-action btn-payment-view" title="Xem chi tiết">
                                ...
                                <a href="{{ route(
                                                ...
                                                $thanh_toan->id
                                            ) }}" class="btn-payment-action btn-payment-edit" title="Cập nhật trạng thái">
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="payment-empty-row">
