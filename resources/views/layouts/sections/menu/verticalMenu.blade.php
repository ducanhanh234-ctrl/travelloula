...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo py-3">
        <a href="{{ url('/') }}" class="app-brand-link w-100 d-flex justify-content-center align-items-center">

            <img src="{{ asset('images/Logo_dọc.png') }}" alt="TravelLoula" style="max-width: 140px; height: auto;">
        </a>
    ...
    <ul class="menu-inner py-1">
        @if(isset($menuData) && isset($menuData[0]->menu))
